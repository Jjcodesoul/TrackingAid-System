...
<div class="app-shell">
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="#" class="{{ request()->is('items*') ? 'active' : '' }}"><i class="fa-solid fa-cube"></i>Inventory</a>
            <a href="#" class="{{ request()->is('items/create') ? 'active' : '' }}"><i class="fa-solid fa-plus"></i>Add Item (SKU)</a>
            <a href="#" class="{{ request()->is('stock-in*') ? 'active' : '' }}"><i class="fa-solid fa-arrow-down"></i>Stock In</a>
